...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_GEM_CTRL_GEM1_SGMII_SD                         0x1

    * GEM SGMII Signal Detect control register
    * (OFFSET, MASK, VALUE)      (0XFF180360, 0x0000000CU ,0x00000004U)
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CTRL_OFFSET, 0x0000000CU, 0x00000004U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_GEM_CLK_CTRL_GEM1_SGMII_MODE                   0x1
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180308, 0x000000C0U ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CLK_CTRL_OFFSET,
		0x000000C0U, 0x000000C0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_QSPI_REF_CTRL_DIVISOR0                          0xf
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0068, 0x013F3F07U ,0x01010F00U)
    */
...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E006C, 0x013F3F07U ,0x01010802U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SDIO1_REF_CTRL_DIVISOR0                         0x20
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0070, 0x013F3F07U ,0x01012002U)
    */
	PSU_Mask_Write(CRL_APB_SDIO1_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01012002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700DC, 0xFFFFFFFFU ,0x0B300301U)
    */
	PSU_Mask_Write(DDRC_INIT3_OFFSET, 0xFFFFFFFFU, 0x0B300301U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * r value. Unit: Clocks.
    *  PSU_DDRC_DRAMTMG1_T_RC                                      0x1b

    * SDRAM Timing Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x0004051BU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x0004051BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070190, 0x1FBFBF3FU ,0x048B8209U)
    */
	PSU_Mask_Write(DDRC_DFITMG0_OFFSET, 0x1FBFBF3FU, 0x048B8209U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000907U)
    */
	PSU_Mask_Write(DDRC_DFITMG2_OFFSET, 0x00003F3FU, 0x00000907U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x08260F0AU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x08260F0AU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00360F09U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00360F09U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080128, 0xFFFFFFFFU ,0x00000C0FU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR6_OFFSET, 0xFFFFFFFFU, 0x00000C0FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080180, 0xFFFFFFFFU ,0x00000A30U)
    */
	PSU_Mask_Write(DDR_PHY_MR0_OFFSET, 0xFFFFFFFFU, 0x00000A30U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  Not Used
    *  PSU_IOU_SLCR_MIO_PIN_44_L3_SEL                              6

    * Configures MIO Pin 44 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800B0, 0x000000FEU ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_44_OFFSET, 0x000000FEU, 0x000000C0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_45_L3_SEL                              6

    * Configures MIO Pin 45 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800B4, 0x000000FEU ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_45_OFFSET, 0x000000FEU, 0x000000C0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x40000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x40000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_SD_CONFIG_REG1_SD0_BASECLK                     0x64
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18031C, 0x00007FFEU ,0x00003250U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG1_OFFSET,
		0x00007FFEU, 0x00003250U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Base Clock Frequency for SD Clock. This is the frequency of the xin_clk.
    *  PSU_IOU_SLCR_SD_CONFIG_REG1_SD1_BASECLK                     0x19
    ...
    * SD Config Register 1
    * (OFFSET, MASK, VALUE)      (0XFF18031C, 0x7FFE0000U ,0x0CD00000U)
    */
	PSU_Mask_Write(IOU_SLCR_SD_CONFIG_REG1_OFFSET,
		0x7FFE0000U, 0x0CD00000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_1_DIRECTION_1                                 0x200

    * Direction mode (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00000200U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x03FFFFFFU, 0x00000200U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_1_OP_ENABLE_1                                  0x200

    * Output enable (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00000200U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x03FFFFFFU, 0x00000200U);
/*##################################################################### */
    ...
    *  PSU_GPIO_MASK_DATA_1_LSW_MASK_1_LSW                         0xfdff

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_1_LSW_DATA_1_LSW                         0x200

    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0xFDFF0200U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
		0xFFFFFFFFU, 0xFDFF0200U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0xFDFF0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
		0xFFFFFFFFU, 0xFDFF0000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * G1A pll ctr bypass value
    *  PSU_SERDES_L1_TM_ILL12_G1A_PLL_CTR_BYP_VAL                  0x0

    * ill pll counter values
    * (OFFSET, MASK, VALUE)      (0XFD405990, 0x000000FFU ,0x00000000U)
    */
	PSU_Mask_Write(SERDES_L1_TM_ILL12_OFFSET, 0x000000FFU, 0x00000000U);
/*##################################################################### */
    ...
    * E ILL F0 CALCODE bypass value. MPHY : G1a, PCIE : Gen 1, SATA : Gen1 , U
    * SB3 : SS
    *  PSU_SERDES_L1_TM_E_ILL1_ILL_BYPASS_E_CALCODE_F0             0x82

    * epi cal code
    * (OFFSET, MASK, VALUE)      (0XFD405924, 0x000000FFU ,0x00000082U)
    */
	PSU_Mask_Write(SERDES_L1_TM_E_ILL1_OFFSET, 0x000000FFU, 0x00000082U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * IQ ILL polytrim bypass value
    *  PSU_SERDES_L1_TM_IQ_ILL8_ILL_BYPASS_IQ_POLYTRIM_VAL         0xFF

    * iqpi polytrim
    * (OFFSET, MASK, VALUE)      (0XFD405914, 0x000000FFU ,0x000000FFU)
    */
...
/*##################################################################### */
    ...
    * E ILL polytrim bypass value
    *  PSU_SERDES_L1_TM_E_ILL8_ILL_BYPASS_E_POLYTRIM_VAL           0xFF

    * epi polytrim
    * (OFFSET, MASK, VALUE)      (0XFD405940, 0x000000FFU ,0x000000FFU)
    */
	PSU_Mask_Write(SERDES_L1_TM_E_ILL8_OFFSET, 0x000000FFU, 0x000000FFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(0,0,0,0,5,0,1,1);
...
/*##################################################################### */
    ...
    *  PSU_SERDES_ICM_CFG0_L1_ICM_CFG                              5

    * ICM Configuration Register 0
    * (OFFSET, MASK, VALUE)      (0XFD410010, 0x00000077U ,0x00000051U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000077U, 0x00000051U);
/*##################################################################### */
    ...
    * Lane 1 Tx Data Bus Witdh. 0x0 - 10 Bits, 0x1 - 20 Bits, 0x2 - 40 Bits, 0
    * x3 - Reserved. When external encoder is disabled, PHY works in 8/16/32 B
    * its mode respecitively
    *  PSU_SERDES_TX_PROT_BUS_WIDTH_L1_TX_PROT_BUSWIDTH            0x0

    * Tx Data Bus Width Control Register
    * (OFFSET, MASK, VALUE)      (0XFD410040, 0x0000000CU ,0x00000000U)
    */
...
/*##################################################################### */
    ...
    * Lane 1 Rx Data Bus Witdh. 0x0 - 10 Bits, 0x1 - 20 Bits, 0x2 - 40 Bits, 0
    * x3 - Reserved. When external encoder is disabled, PHY works in 8/16/32 B
    * its mode respecitively
    *  PSU_SERDES_RX_PROT_BUS_WIDTH_L1_RX_PROT_BUSWIDTH            0x0

    * Rx Data Bus Width Control Register
    * (OFFSET, MASK, VALUE)      (0XFD410044, 0x0000000CU ,0x00000000U)
    */
