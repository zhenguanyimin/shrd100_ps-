...
set psu_clock_init_data {
    ...
    mask_write 0XFF180360 0x0000000C 0x00000004
    ...
    mask_write 0XFF180308 0x000000C0 0x000000C0
    ...
    mask_write 0XFF5E0068 0x013F3F07 0x01010F00
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01010802
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01012002
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x0B300301
    ...
    mask_write 0XFD070104 0x001F1F7F 0x0004051B
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x048B8209
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000907
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x08260F0A
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00360F09
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000C0F
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000A30
...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800B0 0x000000FE 0x000000C0
    ...
    mask_write 0XFF1800B4 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180130 0x000000FE 0x00000080
    ...
    mask_write 0XFF180134 0x000000FE 0x00000080
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x40000000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF18031C 0x00007FFE 0x00003250
    ...
    mask_write 0XFF18031C 0x7FFE0000 0x0CD00000
		# Register : SD_DLL_CTRL @ 0XFF180358</p>
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000200
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000200
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFDFF0200
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFDFF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5US DELAY
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD405990 0x000000FF 0x00000000
    ...
    mask_write 0XFD405924 0x000000FF 0x00000082
    ...
    mask_write 0XFD405914 0x000000FF 0x000000FF
    ...
    mask_write 0XFD405940 0x000000FF 0x000000FF
    ...
    mask_write 0XFD410010 0x00000077 0x00000051
		# : CHECKING PLL LOCK
    ...
    mask_write 0XFD410040 0x0000000C 0x00000000
    ...
    mask_write 0XFD410044 0x0000000C 0x00000000
