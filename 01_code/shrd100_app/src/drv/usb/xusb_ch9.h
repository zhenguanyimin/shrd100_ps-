...
/**
 * @name communication and CDC Device sub Classes
 * @{
 */
#define USB_COMM_CDC_SUB_CLASS_ACM  0x02


/**
 * @name communication and CDC Device sub Classes protocol
 * @{
 */
#define USB_COMM_CDC_SUB_CLASS_ACM_PROTOCOL_AT  0x01
