...
void Ad9361Config_01(void)
{
	...
	u8 Ad9361Config[][3] = {
		...
		//************************************************************
		// Set BBPLL Frequency: 1228.800000
		//************************************************************
		...
		{0x80,0x43,0x33},		//SPIWrite	043,33	// BBPLL Freq Word (Fractional[7:0])
		{0x80,0x42,0xF3},		//SPIWrite	042,F3	// BBPLL Freq Word (Fractional[15:8])
		{0x80,0x41,0x16},		//SPIWrite	041,16	// BBPLL Freq Word (Fractional[23:16])
		{0x80,0x44,0x1E},		//SPIWrite	044,1E	// BBPLL Freq Word (Integer[7:0])
		...
		{0x80,0x02,0x22},		//SPIWrite	002,E2	// Setup Tx Digital Filters/ Channels
		{0x80,0x03,0xE6},		//SPIWrite	003,E6	// Setup Rx Digital Filters/ Channels
...
void Ad9361Config_06(void)
{
	...
	u8 Ad9361Config[][3] = {
		...
		//************************************************************
		// RX Baseband Filter Tuning (Real BW: 25.600000 MHz) 3dB Filter
		// Corner @ 35.840000 MHz)
		//************************************************************
		{0x81,0xFB,0x19},		//SPIWrite	1FB,19	// RX Freq Corner (MHz)
		{0x81,0xFC,0x4D},		//SPIWrite	1FC,4D	// RX Freq Corner (Khz)
		{0x81,0xF8,0x04},		//SPIWrite	1F8,04	// Rx BBF Tune Divider[7:0]
		...
		{0x00,0x16,0x70},		//WAIT_CALDONE	RXFILTER,2000	// Wait for RX filter to tune, Max Cal Time: 1.986 us (Done when 0x016[7]==0)
		...
		// corner.  Real Bandwidth: 24.206877 MHz, ADC Clock Frequency:
		// 614.400000 MHz.  The values in registers 0x200 - 0x227 need to be
		...
		{0x82,0x08,0x22},		//SPIWrite	208,22
		{0x82,0x09,0x3B},		//SPIWrite	209,3B
		{0x82,0x0A,0x4A},		//SPIWrite	20A,4A
		{0x82,0x0B,0x15},		//SPIWrite	20B,15
		{0x82,0x0C,0x4D},		//SPIWrite	20C,4D
		{0x82,0x0D,0x13},		//SPIWrite	20D,13
		...
		{0x82,0x19,0xBC},		//SPIWrite	219,BC
		{0x82,0x1A,0x3C},		//SPIWrite	21A,3C
		{0x82,0x1B,0x1F},		//SPIWrite	21B,1F
		{0x82,0x1C,0xBC},		//SPIWrite	21C,BC
		{0x82,0x1D,0x3C},		//SPIWrite	21D,3C
		{0x82,0x1E,0x1F},		//SPIWrite	21E,1F
		{0x82,0x1F,0xBC},		//SPIWrite	21F,BC
		{0x82,0x20,0x3C},		//SPIWrite	220,3C
		{0x82,0x21,0x3D},		//SPIWrite	221,3D
		{0x82,0x22,0x3E},		//SPIWrite	222,3E
		...
		{0x00,0x16,0x00},		//WAIT_CALDONE	BBDC,2000	// BBDC Max Cal Time: 3945.312 us. Cal done when 0x016[0]==0
		...
		{0x80,0xA0,0x35},		//SPIWrite	0A0,35	// Set TxQuadcal NCO frequency
